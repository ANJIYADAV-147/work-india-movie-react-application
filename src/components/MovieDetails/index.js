...
const MovieDetails = () => {
  ...
  useEffect(() => {
    ...
    getMoviesDetails();
    getCastDetails();
  }, [id]); // Includes 'id' in the dependency array
      ...
      <div className="details-container">
        <div className="movies-details-list-container">
          <div className="img-title-container">
            <img src={`https://image.tmdb.org/t/p/w500${movieDetailList.posterPath}`} alt={movieDetailList.posterPath} className="posterImg" />
            <div className="title-container">
              <h1 className="title">{movieDetailList.title}</h1>
              <p className="rating">vote: {movieDetailList.voteAverage}</p>
              <p className="duration">duration: {movieDetailList.runtime} min</p>
              <p className="releaseDate">Release Date: {movieDetailList.releaseDate}</p>
            </div>
          </div>
        ...
        <img src={`https://image.tmdb.org/t/p/w500${movieDetailList.backdropPath}`} alt={movieDetailList.backdropPath} className="backdrop_path" />
      </div>
